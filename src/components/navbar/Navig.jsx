    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav">
        <li className="nav-item">
          <a className="nav-link active" aria-current="page" href='#b1' >Start</a>
        </li>
        <li className="nav-item">
          <a className="nav-link active" href='#b2'>Project</a>
        </li>
        <li className="nav-item">
          <a className="nav-link active" href='#b3'>About me</a>
        </li>
        <li className="nav-item">
          <a className="nav-link active" href='#b4'>Contact</a>
        </li>
      </ul>
    </div>
